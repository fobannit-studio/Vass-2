...
void UGlobalHotkeys::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<UGlobalHotkeys *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (UGlobalHotkeys::*)(size_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UGlobalHotkeys::activated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UGlobalHotkeys::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_UGlobalHotkeys.data,
    qt_meta_data_UGlobalHotkeys,
    qt_static_metacall,
    nullptr,
    nullptr
} };
