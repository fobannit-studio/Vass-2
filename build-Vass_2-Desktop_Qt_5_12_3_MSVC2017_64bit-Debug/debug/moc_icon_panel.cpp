...
void icon_panel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<icon_panel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject icon_panel::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_icon_panel.data,
    qt_meta_data_icon_panel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
