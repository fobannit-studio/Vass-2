...
public:
    ...
    void setupUi(QWidget *icon_panel)
    {
        ...
        app_1->setGeometry(QRect(30, 0, 80, 90));
...
"QPushButton:pressed{ background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #BEBEBE, stop: 1 #D7D7D7); }"));
        ...
        app_2->setGeometry(QRect(220, 0, 80, 90));
...
"QPushButton:pressed{ background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #BEBEBE, stop: 1 #D7D7D7); }"));
        ...
        app_3->setGeometry(QRect(320, 0, 80, 90));
...
"QPushButton:pressed{ background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #BEBEBE, stop: 1 #D7D7D7); }"));
        ...
        app_4->setGeometry(QRect(30, 90, 80, 90));
...
"QPushButton:pressed{ background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #BEBEBE, stop: 1 #D7D7D7); }"));
        ...
        app_5->setGeometry(QRect(320, 90, 80, 90));
...
"QPushButton:pressed{ background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #BEBEBE, stop: 1 #D7D7D7); }"));
        ...
        app_6->setGeometry(QRect(30, 180, 80, 90));
...
"QPushButton:pressed{ background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #BEBEBE, stop: 1 #D7D7D7); }"));
        ...
        app_7->setGeometry(QRect(220, 180, 80, 90));
...
"QPushButton:pressed{ background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #BEBEBE, stop: 1 #D7D7D7); }"));
        ...
        app_8->setGeometry(QRect(320, 180, 80, 90));
...
"QPushButton:pressed{ background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #BEBEBE, stop: 1 #D7D7D7); }"));
        ...
        removeShortCut->setGeometry(QRect(220, 110, 91, 50));
        removeShortCut->setStyleSheet(QStringLiteral("QPushButton { background-color: rgb(247, 95, 81); color: white; border: 1px solid gray; border-radius:10px} QPushButton:pressed { background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #FF7832, stop: 1 #FF9739); }"));
